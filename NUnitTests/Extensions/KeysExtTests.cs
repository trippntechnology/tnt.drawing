...
{
  [Test]
  public void DoesNotContain_KeyNotPresent_ReturnsTrue()
  {
    // Arrange
    var keys = Keys.Control | Keys.Alt;

    // Act
    bool result = keys.DoesNotContain(Keys.Shift);
  ...
  [Test]
  public void DoesNotContain_KeyPresent_ReturnsFalse()
  {
    // Arrange
    var keys = Keys.Control | Keys.Alt;

    // Act
    bool result = keys.DoesNotContain(Keys.Control);
  ...
  [Test]
  public void DoesNotContain_ExactKeyMatch_ReturnsFalse()
  {
    // Arrange
    var keys = Keys.Shift;
  ...
  [Test]
  public void DoesNotContain_NoKeys_ReturnsTrue()
  {
    // Arrange
    var keys = Keys.None;

    // Act
    bool result = keys.DoesNotContain(Keys.Alt);
